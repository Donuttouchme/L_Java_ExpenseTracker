...
public class DataSeeder implements CommandLineRunner{
    ...
    public void run(String... args){
        ...
        // Saving expenses
        expenseRepository.save(new Expense(new BigDecimal("42.5"), "Migros", LocalDate.now()));
        expenseRepository.save(new Expense(new BigDecimal("11.1"), "Coffee", LocalDate.of(2026,8,20)));
